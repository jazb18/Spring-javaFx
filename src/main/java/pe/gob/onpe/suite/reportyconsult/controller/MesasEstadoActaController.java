 ...
 * @author jzafra
 */
public class MesasEstadoActaController extends AppController implements Initializable {
    ...
    private List<RcEstadoActaDigitacion> estadosDigitacion;
    CheckBox cb1;
    ...
    public void init() {
        ...
        try {
            ...
            stage.show();
            subBarraStage(stage, ConstantReportes.nameTituloMesaEstadoActa, 2);

            estadosDigitacion = rcMesaEstadoMesaService.getObtenerEstadosActa_Digitacion("AA");
//            cboEstado_Click();
            ...
            listaOpciones.add(new Object[]{
                new Object[]{ConstantReportes.FILTRO_ESTADOS_DIGITACION_ACTA, critSelecCtrl.getCmbEstadoDigitacion(), null, 0, 3},
                new Object[]{ConstantReportes.VACIO, critSelecCtrl.getCmbEstadoDigitacion2(), null, 2, 3}
            });
            listaOpciones.add(new Object[]{
    ...
    private void btnImprimirOnAction() throws Exception {
        ...
        try {
            ...
            String CodigoE = ConstantReportes.VACIO;
            String codEstado2 = ConstantReportes.VACIO;
            ...
            InputStream file = this.getClass().getClassLoader().getResourceAsStream(ConstantReportes.pathReportConsult + ConstantReportes.nameReporteMesaEstadoActa + ".jrxml");
            ...
            if (critSelecCtrl.getCmbEstadoDigitacion2().getSelectionModel().getSelectedItem() != null) {
                codEstado2 = critSelecCtrl.getCmbEstadoDigitacion2().getSelectionModel().getSelectedItem().getCodigo();
            }
            ...
            System.out.println(" codTipoElec : " + codTipoElec + " codOdpe : " + codOdpe + " codComputo : " + codComputo + " codEstado : " + CodigoE + " codUbigueo : " + codUbigueo);
            List<RcListadoMesasxEstadoActa> ListMesasActa = rcMesaEstadoActaService.getListadomesasxestadoacta(codTipoElec, codOdpe, descComputo, codEstado, codUbigueo);

            if (ListMesasActa == null || ListMesasActa.size() < 1) {
                validador(0);
                return;
            }
            ...
            parametros.put("reporte", ConstantReportes.nameReporteMesaEstadoActa);
            ...
            parametros.put("tituloSecundario", ConstantReportes.nameTituloListadodeMesaEstadoActa);
            ...
            for (RcListadoMesasxEstadoActa ListData : ListMesasActa) {
            ...
            if (cb1.isSelected()) {
                ...
                String title = ConstantReportes.nameTituloMesaEstadoActa;
                appController.subBarraStageReport(mainStage, sp, title, 2);
            } else {
                String nameReport = "MesaEstadoActa";
    ...
    public void cmdBotones_Click(int valor) {
        switch (valor) {
            case 0:
                comunService.registrarAuditoria(mainStage, "Ingreso a la ventana de Mesa por Estado de Acta - Reportes y Consultas de la Suite Electoral", COD_MOD_REPCON);
                break;
            case 1:
                comunService.registrarAuditoria(mainStage, "Se consulto el reporte Mesa por Estado de Acta - Reportes y Consultas de la Suite Electoral", COD_MOD_REPCON);
                break;
            case 2:
                comunService.registrarAuditoria(mainStage, "Se imprimio el reporte Mesa por Estado de Acta - Reportes y Consultas de la Suite Electoral", COD_MOD_REPCON);
                break;
            case 3:
                comunService.registrarAuditoria(mainStage, "Salio de la ventana de Mesa por Estado de Acta - Reportes y Consultas de la Suite Electoral", COD_MOD_REPCON);
                break;
        }
    }
